...
public class WebConfigurer implements ServletContextInitializer, WebServerFactoryCustomizer<WebServerFactory> {
	 ...
	 *
	 * @param env             the env
	 * @param managementProperties the e proc properties
	 */
	public WebConfigurer(Environment env, ManagementProperties managementProperties) {
		this.env = env;
	...
	public CorsFilter corsFilter() {
		...
		CorsConfiguration config = managementProperties.getCors();
