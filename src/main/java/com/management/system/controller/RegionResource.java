...
import com.management.system.repository.RegionRepository;
import com.management.system.service.RegionService;

/**
 * REST controller for managing {@link com.management.syestem.domain.Region}.
 */
@RestController
@RequestMapping("/api")
public class RegionResource {
    ...
    private static final String ENTITY_NAME = "mastermanagementRegion";
