...
import com.management.system.repository.CountryRepository;
import com.management.system.service.CountryService;

/**
 * REST controller for managing {@link com.management.syestem.domain.Country}.
 */
@RestController
@RequestMapping("/api")
public class CountryResource {
    ...
    private static final String ENTITY_NAME = "mastermanagementCountry";
