...
import com.management.system.repository.JobRepository;
import com.management.system.service.JobService;
import com.management.system.utils.PaginationUtil;

/**
 * REST controller for managing {@link com.management.syestem.domain.Job}.
 */
@RestController
@RequestMapping("/api")
public class JobResource {
    ...
    private static final String ENTITY_NAME = "mastermanagementJob";
