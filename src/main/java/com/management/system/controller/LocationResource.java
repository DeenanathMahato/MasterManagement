...
import com.management.system.repository.LocationRepository;
import com.management.system.service.LocationService;

/**
 * REST controller for managing {@link com.management.syestem.domain.Location}.
 */
@RestController
@RequestMapping("/api")
public class LocationResource {
    ...
    private static final String ENTITY_NAME = "mastermanagementLocation";
